...
class Ui_designMenu(object):
    def setupUi(self, designMenu):
        ...
        designMenu.setStyleSheet("background-color: qlineargradient(spread:repeat, x1:0.456, y1:0.365, x2:0.596, y2:0.465, stop:0.998342 rgba(23, 23, 23, 255), stop:1 rgba(255, 255, 255, 255));")
        self.centralwidget = QtWidgets.QWidget(designMenu)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 541, 71))
        self.label.setMouseTracking(True)
        self.label.setStyleSheet("background-color: rgba(0, 85, 127, 0.7);")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(170, 71, 201, 291))
        self.frame.setStyleSheet("background-color: rgba(0, 0, 0, 0.6);")
