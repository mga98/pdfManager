...
"color: rgb(255, 255, 255);")
        ...
        self.btnPageDelPdf = QtWidgets.QPushButton(self.centralwidget)
        self.btnPageDelPdf.setGeometry(QtCore.QRect(180, 270, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Historic")
        font.setPointSize(10)
        font.setBold(False)
        ...
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.btnPageDelPdf.setFont(font)
        self.btnPageDelPdf.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnPageDelPdf.setStyleSheet("background-color: rgba(71, 238, 0, 0.5);\n"
"color: rgb(255, 255, 255);")
        self.btnPageDelPdf.setObjectName("btnPageDelPdf")
    ...
    def retranslateUi(self, designMenu):
        ...
        self.btnPageDelPdf.setText(_translate("designMenu", "PageDelPDF"))
from . import BgMain
